  ...
  return (
    <div>
      <div className="relative md:min-h-[80vh] lg:min-h-screen py-8 px-12">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center gap-10 p-8">
          <div className="flex flex-col gap-6 bg-gray-100 p-8 rounded-xl shadow-md">
            <div className="flex flex-col items-center justify-center mx-auto pad">
              <Image src={imggame1} alt="Imagen de fondo" layout="responsive" width={400} height={400} />
            </div>
          ...
          <div className="flex flex-col gap-6 bg-gray-100 p-8 rounded-xl shadow-md">
            <div className="flex flex-col items-center justify-center mx-auto pad">
              <Image src={imggame2} alt="Imagen de fondo" layout="responsive" width={400} height={400} />
            </div>
            <p className="text-gray-500">
          ...
          <div className="flex flex-col gap-6 bg-gray-100 p-8 rounded-xl shadow-md">
            <div className="flex flex-col items-center justify-center mx-auto pad">
              <Image src={imggame3} alt="Imagen de fondo" layout="responsive" width={400} height={400} />
            </div>
            <p className="text-gray-500">
          ...
          <div className="flex flex-col gap-6 bg-gray-100 p-8 rounded-xl shadow-md">
            <div className="flex flex-col items-center justify-center mx-auto pad">
              <Image src={imggame4} alt="Imagen de fondo" layout="responsive" width={400} height={400} />
            </div>
            <p className="text-gray-500">
